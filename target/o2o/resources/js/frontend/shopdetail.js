$(function () {
    ...
    function addItems(pageSize, pageIndex) {
        // 拼接出查询的URL，赋空值就默认去掉这个条件的限制，有值就代表按这个条件查询
    ...
    $('#shopdetail-button-div').on('click', '.button', function (e) {
        ...
        if (productCategoryId) {
            // 若之前已选定了别的category，则移除其选定效果，该成选定新的
    ...
    // 需要查询的商品名字发生变化后，重置页码，清空原先的商品列表，按照新的名字重新查询
