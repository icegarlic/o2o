...
public class ProductDaoTest extends BaseTest {
    ...
    public void testCQueryProductByProductId() throws Exception {
        long productId = 1;
        // 初始化俩个商品详情图实例作为productId为 1 的商品下的详情图片
        // 批量插入到商品详情图表中
        ...
        // 查询productId为1 的商品信息并校验返回的详情图实例表size 是否为2
    ...
    public void testEUpdateProductCategoryToNull() {
        // 将productCategoryId 为2 的商品类别下面的商品类别置为空
        int effectedNum = productDao.updateProductCategoryIdToNull(2L);
        assertEquals(2, effectedNum);
    }
